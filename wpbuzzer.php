...
function wpbuzzer_create_button($css=null, $size=null, $show_count=null) {
    ...
    $anchor_tag = '<a title="Post on Google Buzz" class="google-buzz-button" href="http://www.google.com/buzz/post" data-button-style="'.$button_style.'" data-url="'.$url.'" data-imageurl="'.$post_thumb_url.'"></a><script type="text/javascript" src="http://www.google.com/buzz/api/button.js"></script>';
